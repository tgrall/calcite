...
public class RedisearchSort extends Sort implements RedisearchRel {
  ...
  public RedisearchSort(RelOptCluster cluster, RelTraitSet traitSet,
  ...
  @Override public Sort copy(RelTraitSet traitSet, RelNode input,
    ...
    return new RedisearchSort(getCluster(), traitSet, input, collation, offset,
        fetch);
  }

  // TODO : TUG SEARCH SORT
