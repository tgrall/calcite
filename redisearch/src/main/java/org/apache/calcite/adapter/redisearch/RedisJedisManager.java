...
public class RedisJedisManager implements AutoCloseable {
  ...
  public RedisJedisManager(String host, int port, int database, String password, String indexName) {
    ...
    redisearchClient = new Client(this.indexName, this.getJedisPool());
  ...
  public Client getRediSearchClient() {
