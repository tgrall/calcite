...
public class RedisearchToEnumerableConverterRule  extends ConverterRule {
  ...
  public static final ConverterRule INSTANCE = Config.INSTANCE
      .withConversion(RelNode.class, RedisearchRel.CONVENTION,
          EnumerableConvention.INSTANCE, "MongoToEnumerableConverterRule")
      .withRuleFactory(RedisearchToEnumerableConverterRule::new)
      .toRule(RedisearchToEnumerableConverterRule.class);
